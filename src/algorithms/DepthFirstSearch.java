...
public class DepthFirstSearch extends SearchAlgorithm {
    ...
    // Η λίστα "ΑΝΟΙΚΤΕΣ" είαι μια δομή LIFO (last in first out)
    // Υλοποιείται ως στοίβα (Stack)
    ...
    public DepthFirstSearch(SearchGraph searchGraph) {
    ...
    // Αρχικοποίηση - Έναρξη αλγορίθμου
    @Override
    public void start() {
    ...
    // Εκτελείται ένα βήμα του αλγορίθμου
    @Override
    public void step() {
        ...
        // στις κλειστές τερματίζει και ο τρέχον κόμβος ανήκει στους στόχους
        // τερματίζει
        ...
        // Προσωρινή στοίβα όπου κρατάμε τους γείτονες
        // ώστε να μπουν στις ανοικτές με την μεγαλύτερη προτεραιότητα στην κορυφή
        ...
        // Άδειασμα της tempStack στις ανοικτές
        while(!tempStack.isEmpty())
            openNodes.push(tempStack.pop());
